...
if (isset($_POST)) {
    ...
    if ($_POST['accountnumber'] != "") {
        if (empty($_SESSION['getbank'])) {
            ...
            if (empty($accountholder)) {
                ...
                echo "<script>document.getElementById('accountholder').style.borderColor='green'";
            }
            ...
            if ($accountholder != "" && $accounttype != "" & $bankname != "") {
                ...
                $_SESSION['accountholderB'] = $accountholder;
                $_SESSION['accounttypeB'] = $accounttype;
    ...
    if (empty($fullname)) {
        ...
        echo "<script>document.getElementById('fullname').style.borderColor='green';</script>";
    }
    if (empty($type)) {
        echo "<script>document.getElementById('type').style.borderColor='red';</script>";
    } else {
        echo "<script>document.getElementById('type').style.borderColor='green';</script>";
    }
    if (empty($iban)) {
        echo "<script>document.getElementById('iban').style.borderColor='red';</script>";
    } else {
        echo "<script>document.getElementById('iban').style.borderColor='green';</script>";
    }
    if (empty($account)) {
        echo "<script>document.getElementById('account').style.borderColor='red';</script>";
    } else {
        echo "<script>document.getElementById('account').style.borderColor='green';</script>";
    }
    ...
    if ($errorMsg == 0 &&  (isset($_SESSION['getbank']) && $_SESSION['getbank'] == "setted")) {
                                        ...
                                        <a href="#" class="buysell-cc-choosen dropdown-indicator" data-toggle="dropdown">
                                            <div class="coin-item coin-btc">
                                                ...
                                                <div class="coin-info">
                                                    ...
                                                    <span class="coin-text">Balance(<?php echo $money;
                                                                                    echo $accountbalance ?>)</span>
                                                </div>
                                            </div>
                                        </a>
                                                ...
                                                <li class="buysell-cc-item selected">
                                                    <a href="#" class="buysell-cc-opt" data-currency="btc">
                                                        <div class="coin-item coin-btc">
                                                            ...
                                                            <div class="coin-info">
                                                                <span class="coin-name"><?php echo $accounttype ?></span>
                                                                <span class="coin-text"><?php echo substr($accountnumber, 0, 4);
                                                                                        echo "*****"; ?></span>
                                                            </div>
                                                        </div>
                                                    </a>
